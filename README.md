...
* **Isaac-mppi**: an MPPI implementation that uses IsaacGym as a dynamic model ([paper](https://arxiv.org/abs/2307.09105), [website](https://autonomousrobots.nl/paper_websites/isaac-mppi), [code](https://github.com/tud-airlab/mppi-isaac)).
