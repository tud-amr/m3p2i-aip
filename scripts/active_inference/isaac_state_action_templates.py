...
class MDPIsCubeAtGoal:
    def __init__(self): 
        self.state_name = 'isCubeAtGoal'                               
        self.state_names = ['cube_at_goal', 'cube_not_at_goal']          
        ...
        # ----------------------------------------------------------
        self.B[:, :, 0] = np.eye(2)  # Idle action
        self.B[:, :, 1] = np.array([[1, 1],  # pick 
                                    [0, 0]])

        # Preconditions of the actions above
        # ----------------------------------------------------------
        self.preconditions = [['none'], ['cube_not_at_goal']]    # No preconditions needed                 
...
class MDPIsCubeAtPrePlace:
    def __init__(self): 
        self.state_name = 'isCubeAtPrePlace'                               
        self.state_names = ['cube_at_pre_place', 'cube_not_at_pre_place']          
        ...
        # ----------------------------------------------------------
        self.B[:, :, 0] = np.eye(2)  # Idle action
        self.B[:, :, 1] = np.array([[1, 1],  # place 
                                    [0, 0]])

        # Preconditions of the actions above
        # ----------------------------------------------------------
        self.preconditions = [['none'], ['cube_at_pre_place']]    # No preconditions needed                 
